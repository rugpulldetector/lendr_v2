...
abstract contract AddressesConfigurable is OwnableUpgradeable {
	...
	function setLNDRStaking(address _lndrStaking) public onlyOwner {
		lndrStaking = _lndrStaking;
	}

	function setInflationFeed(address _inflationFeed) public onlyOwner {
		inflationFeed = _inflationFeed;
	}
}
