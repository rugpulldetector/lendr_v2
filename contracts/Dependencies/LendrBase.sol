...
import "./BaseMath.sol";
import "./LendrMath.sol";
import "../Interfaces/IActivePool.sol";
import "../Interfaces/IDefaultPool.sol";
import "../Interfaces/ILendrBase.sol";
import "../Interfaces/IAdminContract.sol";
import "../Interfaces/IDefaultPool.sol";
import "../Addresses.sol";

/*
 * Base contract for VesselManager, BorrowerOperations and StakedDebtToken. Contains global system constants and
 * common functions.
 */
abstract contract LendrBase is ILendrBase, BaseMath, OwnableUpgradeable, Addresses {
	...
	function _getTCR(address _asset, uint256 _price) internal view returns (uint256 TCR) {
		...
		TCR = LendrMath._computeCR(entireSystemColl, entireSystemDebt, _price);
	}
